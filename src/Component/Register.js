  ...
  return (
    <Box>
        <Box sx={{backgroundColor:"#F6F6F6"}}>
            <Container>
                <Box sx={{fontSize:28,color:"#34495E",display:"flex",justifyContent:"center",wordSpacing:2,letterSpacing:1,pt:3}}>Get Started With Your Trademark Journey</Box>
      ...
      <Paper sx={{ p: 3 }} elevation={2}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* ---------- Contact ---------- */}
          <Typography mt={2} mb={0.5}  sx={{color:"#34495E",fontSize:14}}>
            Contact Number
          </Typography>
          <TextField
            fullWidth
          ...
          {/* ---------- Product ---------- */}
          <Typography mt={2} mb={0.5}  sx={{color:"#34495E",fontSize:14}}>
           Product or Service Name (તમે જે વસ્તુ અથવા સેવા વેચતા હોય તેનું નામ)
          </Typography>
          <TextField
            fullWidth
            name="productName"
          ...
          {/* ---------- Years Old ---------- */}
          <Typography mt={2} mb={0.5}  sx={{color:"#34495E",fontSize:14}}>
            How many years old / New? (કેટલા સમયથી નામનો ઉપયોગ કરો છો / આ નામથી નવો ધંધો શરૂ કરી રહ્યા છો?) :
          </Typography>
          <TextField
            fullWidth
            name="yearsOld"
          ...
          <Typography fontSize={15} mt={2} sx={{color:"#222222"}}>
            Your details are safe with us. We don't share your data with anyone.
          </Typography>
          ...
          {/* Buttons */}
           {/* <Box sx={{display:"flex",justifyContent:"space-between"}}>
            ...
            <Grid container mt={2} sx={{display:"flex",justifyContent:'space-between'}}>
                <Grid item>
                <Button sx={{backgroundColor:"#F0F0F0",color:"black"}}>Help</Button>
                </Grid>
                <Grid item>
                <Button type="submit" variant="contained" sx={{backgroundColor:"#32c5d2",color:"#FFFFFF"}}>
                    Submit
                </Button>
                </Grid>
            </Grid>
