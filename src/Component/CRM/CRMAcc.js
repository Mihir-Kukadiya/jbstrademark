        ...
        >
          ...
          >
            ...
            <Select
              size="small"
              defaultValue={20}
              sx={{ minWidth: { xs: "calc(50% - 4px)", sm: 70 }, flexGrow: { xs: 1, sm: 0 } }}
            >
              ...
              <Table sx={{ minWidth: { xs: 300, sm: 650 } }}>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Select fullWidth size="small" defaultValue="SUNDRY DEBTORS RECEIVABLE">
                        <MenuItem value="SUNDRY DEBTORS RECEIVABLE">CASH IN HAND</MenuItem>
                        <MenuItem value="BANK ACCOUNT">BANK ACCOUNT</MenuItem>
                        <MenuItem value="BANK OD ACCOUNT">BANK OD ACCOUNT</MenuItem>
                        <MenuItem value="DEPOSITES(ASSETS)">DEPOSITES(ASSETS)</MenuItem>
                        <MenuItem value="LOANS & ADVANCES(ASSETS)">LOANS & ADVANCES(ASSETS)</MenuItem>
                        <MenuItem value="PROVISIONS">PROVISIONS</MenuItem>
                        <MenuItem value="RESERVES & SURPLUS">RESERVES & SURPLUS</MenuItem>
                        <MenuItem value="SECURED LOANS">SECURED LOANS</MenuItem>
                        <MenuItem value="STOCK IN HAND">STOCK IN HAND</MenuItem>
                        <MenuItem value="SUNDRY CREDITORS PAYABLE">SUNDRY CREDITORS PAYABLE</MenuItem>
                        <MenuItem value="SUNDRY DEBTORS RECEIVABLE">SUNDRY DEBTORS RECEIVABLE</MenuItem>
                        <MenuItem value="UNSECURED LOANS">UNSECURED LOANS</MenuItem>
                        <MenuItem value="SALARY EXPENSES">SALARY EXPENSES</MenuItem>
                        <MenuItem value="SALES PRODUCTS">SALES PRODUCTS</MenuItem>
                        <MenuItem value="DUTIES & TAXES (LIABILITIES)">DUTIES & TAXES (LIABILITIES)</MenuItem>
                        <MenuItem value="DUTIES & TAXES (ASSETS)">DUTIES & TAXES (ASSETS)</MenuItem>
                        <MenuItem value="BY OTHER INCOME">BY OTHER INCOME</MenuItem>
                        <MenuItem value="OTHER EXPENSES">OTHER EXPENSES</MenuItem>
                        <MenuItem value="OFFICE EXPENSES">OFFICE EXPENSES</MenuItem>
                        <MenuItem value="OFFICE INCOMES">OFFICE INCOMES</MenuItem>
                        <MenuItem value="LAND AND BUILDING">LAND AND BUILDING</MenuItem>
                        <MenuItem value="FURNITURE AND FIXTURE">FURNITURE AND FIXTURE</MenuItem>
                        <MenuItem value="MANUFACTURING EXPENSE">MANUFACTURING EXPENSE</MenuItem>
                        <MenuItem value="PURCHASE ACCOUNT">PURCHASE ACCOUNT</MenuItem>
                      </Select>
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, display: { xs: "none", md: "table-cell" }, fontSize: { xs: "0.875rem", sm: "1rem" }, whiteSpace: "nowrap", pr: 1 }}>
                      Balance
                    ...
                    <TableCell sx={{ display: { xs: "none", md: "table-cell" } }}>
                      <Box sx={{ display: "flex", gap: 1 }}>
                        <TextField fullWidth size="small" defaultValue="0" InputProps={{ sx: { height: 35 } }} />
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Box sx={{ display: "flex", gap: 1 }}>
                        <TextField fullWidth size="small" placeholder="eg. Whatsapp" InputProps={{ sx: { height: 35 } }} />
                        <TextField fullWidth size="small" placeholder="eg. 9898989898" InputProps={{ sx: { height: 35 } }} />
                      </Box>
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, display: { xs: "none", md: "table-cell" }, fontSize: { xs: "0.875rem", sm: "1rem" }, whiteSpace: "nowrap", pr: 1 }}>
                      Email
                  ...
                  {/* Other - Mobile Only */}
                  <TableRow sx={{ display: { xs: "table-row", md: "none" } }}>
                    <TableCell sx={{ fontWeight: 600, fontSize: "0.875rem" }}>Other</TableCell>
                    <TableCell>
                      <TextField fullWidth size="small" InputProps={{ sx: { height: 35 } }} />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ display: { xs: "none", md: "table-cell" } }}>
                      <TextField fullWidth size="small" defaultValue="Gujarat" InputProps={{ sx: { height: 35 } }} />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ display: { xs: "none", md: "table-cell" } }}>
                      <TextField fullWidth size="small" type="password" InputProps={{ sx: { height: 35 } }} />
                    </TableCell>
                  </TableRow>
